            ...
            {cart.cartProducts.length === 0 ? (
                    ...
                    { cart.cartProducts.map(cartProduct => (
                        ...
                        <div className="mt-[20px] grid grid-cols-4 place-items-center mb-[50px]">
                            ...
                            <div className="grid place-items-center">
                                ...
                                <button onClick={() => handleRemoveFromCart(cartProduct)} className="hover:text-pink-700">Remove</button>
                            </div>
                            {/* Price */}
                            ...
                            <div className=" text-[40px] font-normal bg-gray-300 rounded px-2">
                                <button onClick={() => handleDecreaseFromCart(cartProduct)} className="hover:text-white">-</button>
                                <span className="mx-2">{cartProduct.cartQuantity}</span>
                                <button onClick={() => handleIncreaseFromProduct(cartProduct)} className="hover:text-white">+</button>
                            </div>
                            {/* Total */}
                ...
                <div className="summary grid col-span-1 grid-cols-4 place-items-center py-5">
                    ...
                    <div className="col-start-4 col-span-1">
                        <h1 className="text-[40px] text-center font-bold mb-[30px]">
